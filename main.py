...
def admin_only(function):
    ...
    def decorated_function(*args, **kwargs):
        try:
            ...
            # if there is no user logged in, ask for login
...
def register():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            flash("You're already signed up with email, please login instead!")
            return redirect(url_for("login"))
...
def login():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            flash('That email has not been registered, please try again.')
...
def delete_comment(comment_id):
    ...
    post = BlogPost.query.get(comment_to_delete.post_id)
